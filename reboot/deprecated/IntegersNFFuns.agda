-- Cache for different attempts at a normalisation function
-- for the Integers example.
-- Some worked but were too much of a black-box to prove the required
-- properties, others had termination issues.
-- We found the 'correct' version on 27 April 2026 (Nicollò and I).

-- Also outdated comment:
--
