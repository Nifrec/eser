-- Module      : Eser.Signature.Equivalences
...
--
-- 1. TerseFreeTerms and RoundedTerms are in bijection, i.e., represent the same
...
-- 3. Corollary of 1. and 2.: TerseFreeTerms ≃ RoundedTerms ≃ ℕ
--------------------------------------------------------------------------------
...
module Eser.Signature.Equivalences where
