...
opaque
    ...
    incrFirst-injective {m} {w} {x ∷ xs , eq-v} {y ∷ ys , eq-u} eq = ans
        where
            ...
            ans : _≡_ {A = WVec m w} (x ∷ xs , eq-v) (y ∷ ys , eq-u)
...
opaque
    ...
    getWVec-complete {suc m} {suc w} (ℕ.zero ∷ xs , eq) = (j , outp)
        where
            ...
            vecs : Vec (WVec (suc m) (suc w)) (n-l + n-r)
